                              ...
                              <tbody>
                                <tr>
                                  <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;" align="left" bgcolor="#ffffff">
                                    ...
                                    <p class="" style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">Nombre: {{$compra->Nombre}}<br>Telefono: {{$compra->Telefono}}<br>Ciudad: {{$compra->Ciudad}}<br>Cedula: {{$compra->Cedula}}<br>Producto:{{$compra->producto->Nombre}}<br>Direccion: {{$compra->Direccion}}<br>Depertamento: {{$compra->Departamento}}<br>Unidades: {{$compra->Unity}}<br>Correo: {{$compra->Correo}}</p>
                                    <table class="s-4 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                      <tbody>
                                        <tr>
                                          <td style="line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;" align="left" width="100%" height="16">
                                      ...
                                      <tbody>
                                        <tr>
                                          <td style="line-height: 24px; font-size: 16px; border-radius: 6px; font-weight: 700 !important; margin: 0;" align="center" bgcolor="#0d6efd">
                                            <a href="{{asset('/')}}" style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: 700 !important; white-space: nowrap; background-color: #0d6efd; padding: 12px; border: 1px solid #0d6efd;">Visit Website</a>
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
